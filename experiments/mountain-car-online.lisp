(asdf:load-system :bes)
(setf py4cl:*python-command* "~/Repos/bes-gym/venv/bin/python3")
(py4cl:import-module "numpy" :as "np")
(py4cl:import-module "random")
(py4cl:import-module "gymnasium" :as "gym")
(asdf:load-system :bes-gym)
...
(defparameter *rollout-fn* (bes-gym:make-rollout-fn-with-data-tracking "MountainCar-v0" :evaluations-file "~/Desktop/evaluations.dat"))
(defparameter *results-folder* (format nil "/Users/brycemacinnis/experiments/mountain-car/online/~A/" (substitute #\- #\: (timestamp))))

(ensure-directories-exist *results-folder*)

(evolve-with-data-tracking #'breeder-with-data-tracking *rollout-fn*
                           :mode 'tpg
                           :budget 100
