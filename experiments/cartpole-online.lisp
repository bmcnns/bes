...
(defparameter *rollout-fn* (bes-gym:make-rollout-fn-with-data-tracking "CartPole-v1" :evaluations-file "~/Desktop/evaluations.dat"))
(defparameter *results-folder* (format nil "/Users/brycemacinnis/experiments/cartpole/online/~A/" (substitute #\- #\: (timestamp))))
