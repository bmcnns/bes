...
(defparameter *rollout-fn* (bes-gym:make-rollout-fn-with-data-tracking "Acrobot-v1" :evaluations-file "~/Desktop/evaluations.dat"))
(defparameter *results-folder* (format nil "/Users/brycemacinnis/experiments/acrobot/online/~A/" (substitute #\- #\: (timestamp))))
