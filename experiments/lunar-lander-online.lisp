...
(defparameter *rollout-fn* (bes-gym:make-rollout-fn-with-data-tracking "LunarLander-v3" :evaluations-file "~/Desktop/evaluations.dat"))
(defparameter *results-folder* (format nil "/Users/brycemacinnis/experiments/lunar-lander/online/~A/" (substitute #\- #\: (timestamp))))
